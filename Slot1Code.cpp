...
const int rgbForTempRedPin = 3;     
const int rgbForTempGreenPin = 2;   
const int buzzerForTempPin = 4;
const int gasSensorPin = A2;
const int rgbForGasRedPin = 13;
const int rgbForGasGreenPin = 12;
const int buzzerForGasPin = 5;
const int alertPin = 11;
